<template>
  <div class="anime-card bg-gradient-dark rounded-2xl pt-12 px-6 pb-6 shadow-violet w-full hover:shadow-pink transition-all duration-300 border border-violet-700/30 hover:border-pink-500/60 group">
    <!-- Voice Icon -->
    ...
    <!-- Cost Badge -->
    <div class="bg-gradient-to-r from-violet-500/20 to-pink-500/20 backdrop-blur-sm border border-violet-500/40 text-violet-300 px-4 py-2 rounded-xl text-sm font-bold text-center mb-4">
    ...
    <!-- Voice Name -->
    <h2 class="text-2xl font-bold text-white text-center mb-6 group-hover:text-gradient transition-colors duration-300">
      {{ voice.name }}
    </h2>
    ...
    <div class="glass rounded-xl p-4 border border-violet-700/20">
      <p class="text-gray-300 text-center text-sm leading-relaxed">
        <span class="text-violet-300 font-mono bg-violet-900/30 px-2 py-1 rounded">[{{ voice.name.toLowerCase() }}]</span> 
