  ...
  setup(props) {
    ...
    return () =>
      h('div', {class: 'flex space-x-1'}, [
        h('div', {class: 'w-3 h-3 rounded-full', style: {backgroundColor: colors.value.primary}}),
        h('div', {class: 'w-3 h-3 rounded-full', style: {backgroundColor: colors.value.secondary}}),
        h('div', {class: 'w-3 h-3 rounded-full', style: {backgroundColor: colors.value.accent}}),
      ]);
  },
});
